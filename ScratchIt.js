function ScratchIt(){
  ...
  var onCanvasLoaded = function(){
    ...
    if(window.PointerEvent){
      ...
      overlayCanvas.addEventListener('mouseenter', (e) => {document.getElementById('scratch').style.zIndex ='1';document.getElementById('top-text').style.zIndex ='0'; cursor.style.height = '120px';cursor.style.width = '120px';})
      overlayCanvas.addEventListener('mouseleave', (e) => {document.getElementById('scratch').style.zIndex ='0';document.getElementById('top-text').style.zIndex ='1'; cursor.style.height = '40px';cursor.style.width = '40px';})
